...
export class RobotService {
  ...
  public createRobot(robot: RobotResponseDTO, showSpinner?: boolean): Observable<RobotDTO> {
    return this.http.post<RobotDTO>(`${this.API_URL}/api/robots`, robot, {reportProgress: showSpinner});
  }
